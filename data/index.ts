...
export const gridItems = [
  {
    id: 1,
    title: "Prioritize client wishes, offering open communication",
    description: "",
  ...
  {
    id: 4,
    title: "Developing with Creativity.",
    description: "",
  ...
  {
    id: 5,
    title: "Currently building a Weather API",
...
export const projects = [
  {
    id: 1,
    title: "GoFruit.id",
    des: "Manage your product inventory using our inventory system. Seamlessly Inventory system using GoFruit.id.",
    img: "/p1.svg",
    iconLists: ["/re.svg", "/tail.svg", "/ts.svg", "/mysql.svg", "/python.svg"],
    link: "/GoFruit.id",
    plink: "GoFruit.id",
  },
  {
    id: 2,
    title: "Mekitam - Video Conferencing Website",
    des: "Lift up your video conference experience using mekitam.",
    img: "/p2.svg",
    iconLists: ["/next.svg", "/tail.svg", "/js.svg", "/php.svg"],
    link: "/mekitam.com",
    plink: "mekitam.com",
  },
  // {
...
export const testimonials = [
  {
    quote:
      "I had the pleasure of working with Is'ad on our latest game project, and the experience was nothing short of exceptional. From the initial concept phase to the final release, Is'ad demonstrated an impressive level of skill, creativity, and dedication. If you're seeking game developer with infinity ideas, Is'ad is the ideal partner.",
    name: "Atta",
    title: "Owner of Dot Roleplay",
    img: "/profile.svg",
  },
  {
    quote:
...
export const workExperience = [
  {
    ...
    desc: "Game developer using Lua, Developed roblox and fivem games",
  ...
  },
  {
    ...
    desc: "Developed and maintained API using Djanggo RestAPI and backing it up using Datadog.",
